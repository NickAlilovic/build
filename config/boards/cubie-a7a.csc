# Allwinner A733 (sun60iw2) octa-core 2-16GB LPDDR5, WiFi6/BT (USB), NPU, GPU, PCIe, UFS
...
SUNXI_BOOT0_SDCARD_FEX="${SRC}/packages/blobs/sunxi/sun60iw2/boot0_cubie-a7a.fex"
SUNXI_BOOT0_SPINOR_FEX="${SRC}/packages/blobs/sunxi/sun60iw2/boot0_cubie-a7a.fex"
SUNXI_SYS_CONFIG_FEX="${SRC}/packages/blobs/sunxi/sun60iw2/sys_config_cubie-a7a.fex"
...
# The A7A boots from a different offset than the Orange Pi boards, so it overrides
